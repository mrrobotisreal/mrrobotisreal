...
For years I've been a self-taught learner, successfully worked as a professional software engineer, and I never really thought about getting a degree, but I finally decided to take on finishing a **Bachelor's Degree (B.S.) in Computer Science** to see what all I can glean from it while getting the paper to back it up, so I'm currently working through this and obtaining numerous additional certifications along the way (_CompTIA A+_, _CompTIA Security+_, _CompTIA Network+_, _CEH Certified Ethical Hacker_, and eventually OSCP).
